...
pois = [
    {"name": "Museo Nacional del Prado", "category": "museum",
     "description": "Coleccion de obras de arte de los siglos XII a XIX y obras maestras de Velazquez, Goya y el Greco",
    ...
    {"name": "CaixaForum Madrid", "category": "museum",
     "description": "Centro artistico creado por Herzog & de Meuron y antigua central electrica, con exposiciones y actuaciones",
    ...
    {"name": "Congreso de los Diputados", "category": "building", "description": "Oficina de la administracion",
    ...
    {"name": "Fuente de Neptuno", "category": "building", "description": "Fuente",
     "direction": "Plaza Canovas del Castillo, s/n, 28014 Madrid",
    ...
    {"name": "Fuente de Cibeles", "category": "building", "description": "Atraccion turistica",
     "direction": "Calle de Alcala, 3, 28014 Madrid",
    ...
    {"name": "Basilica de Jesus de Medinaceli", "category": "church", "description": "Lugar de culto",
     "direction": "Plaza Jesus, 2, 28014 Madrid",
